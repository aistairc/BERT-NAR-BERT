...
""" Classes to support Encoder-Vae-Decoder architectures"""
...
class EncoderVaeDecoderModel(PreTrainedModel):
    r"""
    [`EncoderVaeDecoderModel`] is a generic model class that will be instantiated as a transformer architecture with one
