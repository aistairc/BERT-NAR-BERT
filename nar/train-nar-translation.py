...
model = EncoderDecoderModel.from_pretrained(
    "/groups/gac50543/migrated_from_SFA_GPFS/asada/pretraining/VAEsent-wiki-en-full/checkpoint-40000/",
    config=config)
...
training_args = Seq2SeqTrainingArguments(
    output_dir="~/my_data/translation/wmt14DeEn-from-wikiEn-VAE-sent/",
    ...
    fp16=True,
    report_to="wandb",
    run_name="wmt14DeEn-from-wikiEn-VAE-sent",
)
