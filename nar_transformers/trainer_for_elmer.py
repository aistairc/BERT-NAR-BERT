...
"""
The Trainer class, to easily train a ð¤ Transformers from scratch or finetune it on a new task.
"""
...
class Trainer:
    """
    Trainer is a simple but feature-complete training and eval loop for PyTorch, optimized for ð¤ Transformers.
    ...
    Args:
        model ([`PreTrainedModel`] or `torch.nn.Module`, *optional*):
            ...
            your own models defined as `torch.nn.Module` as long as they work the same way as the ð¤ Transformers
            models.
    ...
    def push_to_hub(self, commit_message: Optional[str] = "End of training", blocking: bool = True, **kwargs) -> str:
        """
        Upload *self.model* and *self.tokenizer* to the ð¤ model hub on the repo *self.args.hub_model_id*.
