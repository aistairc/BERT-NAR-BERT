...
class PretrainedConfig(object):
    ...
    Args:
        ...
        is_encoder_vae_decoder (:obj:`bool`, `optional`, defaults to :obj:`False`):
            Whether the model is used vae to connect encoder/decoder or not.
    ...
    def __init__(self, **kwargs):
        ...
        self.is_encoder_vae_decoder = kwargs.pop("is_encoder_vae_decoder", False)
