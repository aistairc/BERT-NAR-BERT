...
_CONFIG_FOR_DOC = "EncoderVaeDecoderConfig"

ENCODER_VAE_DECODER_START_DOCSTRING = r"""
...
ENCODER_VAE_DECODER_INPUTS_DOCSTRING = r"""
    Args:
...
@add_start_docstrings(ENCODER_VAE_DECODER_START_DOCSTRING)
class EncoderVaeDecoderModel(PreTrainedModel):
    r"""
    ...
    """
    config_class = EncoderVaeDecoderConfig
    base_model_prefix = "encoder_vae_decoder"
    print("Using Model: ", base_model_prefix)
    ...
    def __init__(
        ...
        if config is None:
            config = EncoderVaeDecoderConfig.from_encoder_vae_decoder_configs(encoder.config, decoder.config)
        else:
    ...
    @classmethod
    def from_encoder_vae_decoder_pretrained(
        cls,
        ...
        **kwargs
        ...
        Example::
            ...
            >>> from pytorch_transformers import EncoderVaeDecoderModel
            >>> # initialize a bert2bert from two pretrained BERT models. Note that the cross-attention layers will be randomly initialized
            >>> model = EncoderVaeDecoderModel.from_encoder_vae_decoder_pretrained('bert-base-uncased', 'bert-base-uncased')
            >>> # saving model after fine-tuning
            >>> model.save_pretrained("./bert2bert")
            >>> # load fine-tuned model
            >>> model = EncoderVaeDecoderModel.from_pretrained("./bert2bert")
    ...
    def forward(
        ...
        **kwargs
        ...
        Examples::
            ...
            >>> from pytorch_transformers import EncoderVaeDecoderModel, BertTokenizer
            >>> import torch

            >>> tokenizer = BertTokenizer.from_pretrained('bert-base-uncased')
            >>> model = EncoderVaeDecoderModel.from_encoder_vae_decoder_pretrained('bert-base-uncased', 'bert-base-uncased') # initialize Bert2Bert from pre-trained checkpoints
        ...
        #generated = torch.multinomial(probabilities, num_samples=1, replacement=True).flatten()
        #print(generated)
        #exit()


        #encoded = EncoderVaeDecoderModel.generate(generated, attention_mask=attention_mask)
        ...
        decoder_input_ids = input_ids.masked_fill((input_ids != self.config.bos_token_id)
