...
_import_structure = {
    ...
    "models.encoder_vae_decoder": ["EncoderVaeDecoderConfig"],
...
if is_torch_available():
    ...
    _import_structure["models.encoder_vae_decoder"].append("EncoderVaeDecoderModel")
...
if TYPE_CHECKING:
    ...
    from .models.encoder_vae_decoder import EncoderVaeDecoderConfig
    ...
    if is_torch_available():
        ...
        from .models.encoder_vae_decoder import EncoderVaeDecoderModel
